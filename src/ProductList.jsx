...
function ProductList({ onHomeClick }) {
    ...
    const handleHomeClick = (e) => {
        e.preventDefault();
        onHomeClick();
        setShowCart(false); // Ensure cart is hidden when navigating home
        setShowPlants(true); // Ensure plants are shown when navigating home
    };
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowPlants(true);
        setShowCart(false); // Hide cart when plants are shown
    };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div className="ul">
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)}><h3 className="cart">
                        <img src="https://cdn-icons-png.flaticon.com/512/2838/2838895.png" alt="" />
                        <p className="cart_quantity_count">{cartQuantity}</p>
                    </h3></a></div>
                </div>
            </div>
                        ...
                        <div key={index}>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, idx) => (
                                    <ProductCard key={idx} plant={plant} />
                                ))}
                            </div>
                        </div>
                    ))}
